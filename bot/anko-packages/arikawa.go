// Code generated by anko-package-gen2 --name arikawa --pkg github.com/diamondburned/arikawa/v3 -v v3.0.0-20210812011650-21888dcfc212. DO NOT EDIT.
...
func init() {
	...
	initArikawaBot()
	initArikawaBotExtrasArguments()
	initArikawaBotExtrasInfer()
	initArikawaBotExtrasMiddlewares()
	initArikawaBotExtrasShellwords()
	initArikawaDiscord()
	initArikawaGateway()
...
func initArikawaApi() {
	...
	env.PackageTypes["github.com/diamondburned/arikawa/v3/api"] = map[string]reflect.Type{
		...
		"ActiveThread":                    reflect.TypeOf((*api.ActiveThread)(nil)).Elem(),
...
func initArikawaBot() {
	env.Packages["github.com/diamondburned/arikawa/v3/bot"] = map[string]reflect.Value{
		// constants
	...
	env.PackageTypes["github.com/diamondburned/arikawa/v3/bot"] = map[string]reflect.Type{
...
func initArikawaBotExtrasArguments() {
	env.Packages["github.com/diamondburned/arikawa/v3/bot/extras/arguments"] = map[string]reflect.Value{
		// constants
	...
	env.PackageTypes["github.com/diamondburned/arikawa/v3/bot/extras/arguments"] = map[string]reflect.Type{
...
func initArikawaBotExtrasInfer() {
	env.Packages["github.com/diamondburned/arikawa/v3/bot/extras/infer"] = map[string]reflect.Value{
		// constants
	...
	env.PackageTypes["github.com/diamondburned/arikawa/v3/bot/extras/infer"] = map[string]reflect.Type{}
}

func initArikawaBotExtrasMiddlewares() {
	env.Packages["github.com/diamondburned/arikawa/v3/bot/extras/middlewares"] = map[string]reflect.Value{
		// constants
	...
	env.PackageTypes["github.com/diamondburned/arikawa/v3/bot/extras/middlewares"] = map[string]reflect.Type{}
}

func initArikawaBotExtrasShellwords() {
	env.Packages["github.com/diamondburned/arikawa/v3/bot/extras/shellwords"] = map[string]reflect.Value{
		// constants
	...
	env.PackageTypes["github.com/diamondburned/arikawa/v3/bot/extras/shellwords"] = map[string]reflect.Type{
...
func initArikawaDiscord() {
	env.Packages["github.com/diamondburned/arikawa/v3/discord"] = map[string]reflect.Value{
		...
		"ApplicationCommandMessage":               reflect.ValueOf(discord.ApplicationCommandMessage),
		...
		"PermissionUsePrivateThreads":             reflect.ValueOf(discord.PermissionUsePrivateThreads),
		"PermissionUsePublicThreads":              reflect.ValueOf(discord.PermissionUsePublicThreads),
...
func initArikawaGateway() {
	env.Packages["github.com/diamondburned/arikawa/v3/gateway"] = map[string]reflect.Value{
		...
		"ButtonInteraction":            reflect.ValueOf(gateway.ButtonInteraction),
		"CallConnectOP":                reflect.ValueOf(gateway.CallConnectOP),
		"CommandInteraction":           reflect.ValueOf(gateway.CommandInteraction),
		...
		"PingInteraction":              reflect.ValueOf(gateway.PingInteraction),
	...
	env.PackageTypes["github.com/diamondburned/arikawa/v3/gateway"] = map[string]reflect.Type{
		"ApplicationCommandUpdateEvent":   reflect.TypeOf((*gateway.ApplicationCommandUpdateEvent)(nil)).Elem(),
		...
		"InteractionData":                 reflect.TypeOf((*gateway.InteractionData)(nil)).Elem(),
		"InteractionOption":               reflect.TypeOf((*gateway.InteractionOption)(nil)).Elem(),
		"InteractionType":                 reflect.TypeOf((*gateway.InteractionType)(nil)).Elem(),
...
func initArikawaUtilsJsonOption() {
	env.Packages["github.com/diamondburned/arikawa/v3/utils/json/option"] = map[string]reflect.Value{
		...
		"NullColor":     reflect.ValueOf(option.NullColor),
		...
		"ZeroSeconds":   reflect.ValueOf(option.ZeroSeconds),
		"ZeroUint":      reflect.ValueOf(option.ZeroUint),

		// functions
		"NewColor":          reflect.ValueOf(option.NewColor),
		"NewInt":            reflect.ValueOf(option.NewInt),
		"NewNullableColor":  reflect.ValueOf(option.NewNullableColor),
		...
		"NewSeconds":        reflect.ValueOf(option.NewSeconds),
	...
	env.PackageTypes["github.com/diamondburned/arikawa/v3/utils/json/option"] = map[string]reflect.Type{
		...
		"Color":              reflect.TypeOf((*option.Color)(nil)).Elem(),
		...
		"NullableColor":      reflect.TypeOf((*option.NullableColor)(nil)).Elem(),
		"NullableColorData":  reflect.TypeOf((*option.NullableColorData)(nil)).Elem(),
		...
		"Seconds":            reflect.TypeOf((*option.Seconds)(nil)).Elem(),
