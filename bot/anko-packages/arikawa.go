// Code generated by anko-package-gen2 --name arikawa --pkg github.com/diamondburned/arikawa/v3 -v v3.0.0-rc.6. DO NOT EDIT.
...
func initArikawaApi() {
	...
	env.PackageTypes["github.com/diamondburned/arikawa/v3/api"] = map[string]reflect.Type{
		...
		"AutocompleteChoice":              reflect.TypeOf((*api.AutocompleteChoice)(nil)).Elem(),
...
func initArikawaVoice() {
	...
	env.PackageTypes["github.com/diamondburned/arikawa/v3/voice"] = map[string]reflect.Type{
		...
		"UDPDialer":      reflect.TypeOf((*voice.UDPDialer)(nil)).Elem(),
	}
}
