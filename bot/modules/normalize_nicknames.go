...
var (
	...
	replacements = []Replacement{
		...
		makeReplacement("E", "Ⓔ🅔Ｅ𝐄𝕰𝑬𝓔𝔼𝙴𝖤𝗘𝙀𝘌🄴🅴🇪𝔈ᴱƎËĒĔĖĘĚȄȆȨɆΈΕЀЁЕӖᴇḔḖḘḚḜẸẺẼẾỀỂỄỆἘἙἚἛἜἝῈΈℰⴹꓰ𐊆𐊤𐌄𑀚𝚬𝛦𝜠𝝚𝞔🄔ᴲ∃∄ⱻꓱཇཛᎬ"),
		...
		makeReplacement("N", "Ⓝ🅝Ｎ𝐍𝕹𝑵𝓝ℕ𝙽𝖭𝗡𝙉𝘕🄽🅽🇳𝔑ᴺИÑŃŅŇŊƝǸɴΝᶰṄṆṈṊⲚⲛꓠꞐꞤ𐊏𐊪𐌽𝚴𝛮𝜨𝝢🄝ͶЍЙҊᴻ"),
